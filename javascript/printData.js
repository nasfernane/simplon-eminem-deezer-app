...
const displayAlbums = function () {
    ...
    for (const item of data) {
        ...
        document.querySelector(`.card:last-child img`).alt =
            item.album.cover_big;
        document.querySelector(`.card:last-child .card-body a`).href =
            item.album.tracklist;
        document.querySelector(`.card:last-child .card-body h5`).textContent =
            item.title;
        document.querySelector(`.card:last-child .card-body audio`).src =
            item.preview;
